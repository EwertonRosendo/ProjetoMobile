  ...
  function cortes(){
    return (
      ...
      <View>
        ...
        <TouchableOpacity activeOpacity={0.5} onPress={()=>setValorSomado(valorSomado+item.valor)} >
          <View style={styles.linha}>
            ...
            <View style={styles.areaTexto}>
              ...
              <Text style={styles.desccorte}> {item.descCorte} </Text>  
          
            </View>
          
            <View style={styles.areaFoto}>
          
              <Image source={{uri: item.linkImg}} style={styles.image} />
